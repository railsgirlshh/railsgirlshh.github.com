...
* Cloudservice (z.B. nitrous): Melde Dich an Deinem Account an, starte Dein Projekt und wechsel in die Entwicklungsumgebung IDE (siehe [Installationsanleitung](/install#using-a-cloud-service)). Das Terminal befindet sich normalerweise im unteren Bereich des Browserfensters.
