...
function initializeOsSwitchers() {
  $(".os-specific").append("<span class='picker'>Betriebssystem: <a href='#' class='win-link'>Windows</a> | <a href='#' class='nix-link'>Sonstige</a></span>").find(".win-link").click(function(event) {
